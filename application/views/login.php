    ...
    <body style="background: linear-gradient(#D484BA, #6BBD63);">
        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                ...
                <form class="form-horizontal m-t-1" action="<?php echo base_url('users/login')?>" method="POST">
                    
                    <div class="form-group ">
                        <center>
						<img src="<?php echo base_url()?>/assets/images/admin.png" alt="admin"width="100"height="70" />
                            <h2>Login</h2>
                        </center>
                    </div>
                    ...
                    <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
							...
							<button class="btn btn-lg btn-success btn-block btn-signin" type="submit" id="loginSub">Sign in</button>
                        </div>
                    </div>
					...
					<div class="form-group m-t-30">
                        ...
                        <div class="col-sm-6">
                            <a href="<?php echo base_url('users/registration')?>">Create an account</a>
                        </div>
						<div class="col-sm-3"> </div>
                    </div>
