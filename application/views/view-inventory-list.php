                ...
                <div class="content">
					...
					<?php endif; ?>
                        ...
                        <div class="row">
                                    ...
                                    <div class="panel-body">
                                        <div class=" form">
											...
											<div class="col-lg-6">
												...
												<div class="form-group ">
													<label for="cname" class=" col-lg-4">Bill/Voucher Image</label>
                                                    
                                                        <input class=" form-control" id="cname" name="bill_image" type="file" required="" aria-required="true">
											...
											<div class="col-lg-5">
												...
												<div class="form-group ">
													<label for="cname" class=" col-lg-4">Inventory Image</label>
                                                    
                                                        <input class=" form-control" id="cname" name="inventory_image" type="file" required="" aria-required="true">
                                                   
                                                </div>
												<div class="form-group ">
													<label for="cname" class=" col-lg-4"> Purchase Date</label>
                                                   <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker" name="purchase_date">
													
                                                   
                                                </div>
												<div class="form-group ">
													<label for="cname" class=" col-lg-4"> W.Expiry Date</label>
                                                   <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker1" name="warranty_ex_date">
							...
							<button class="btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#custom-width-modal"> +ADD New</button>
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
													...
													foreach($inventories as $inventory)
													{
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><img src="<?php echo base_url('/').$inventory->bill_image;?>" alt="inventory image" width="70" height="60" /></td>
                                                            <td> Active </td>
															<?php 
															if($inventory->assignment_status=="1")
															{
																...
																&nbsp;&nbsp;<a href="<?php echo base_url('inventory/show-assignment/').$inventory->id;?>" class="btn btn-success"data-toggle="tooltip" data-placement="right" title="View Assignment">Assigned </a>
																</td>
																<?php 
															}
															else 
															{
																?>
																<td style="color:red">
																<a href="<?php echo base_url('inventory/show-assignment/').$inventory->id;?>" class="btn btn-danger"data-toggle="tooltip" data-placement="right"title=" Assign Now">Not Assigned </a>
																</td>
																<?php 
															}
                                                            ...
                                                            <td> 
															<a href="#" title="View" class="on-default edit-row"><i class="fa fa-eye"></i></a> 
															
															&nbsp;&nbsp;||&nbsp;&nbsp;
															<a href="#" class="on-default edit-row" title="Edit"><i class="fa fa-pencil"style="color:#29B6F6"></i></a> 
															&nbsp;&nbsp;|| &nbsp;&nbsp; 
															<a href="#" title="Remove"class="on-default remove-row"><i class="fa fa-trash-o" style="color:red"></i></a></td>
                                                        </tr>
													<?php 
													}
